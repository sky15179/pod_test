...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/sky15179/pod_test'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'sky15179' => 'wangzhigang03@maoyan.com' }
  s.source           = { :git => 'https://github.com/sky15179/pod_test.git', :tag => s.version.to_s }
